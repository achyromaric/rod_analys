...
extern void		COMMUN_Date_du_jour(char *format, char *resultat);
...
extern int		COMMUN_get_passwd(char *p_user_file, char *p_nom_instance, char *p_nom_util, char *p_mot_de_passe);
...
extern int		COMMUN_lire_info(char *p_cfg_file, char *p_instance, char *p_info, char *p_var_dest);
...
extern int		COMMUN_lire_message_erreur(char *p_fichier_log, char *p_tag_message, char* p_resultat);
...
extern int		COMMUN_lancer_commande(char *p_commande, char *p_nom_fichier, char *p_fichier_sortie);
...
extern int		COMMUN_Get_Version_Aster(char *p_version);
extern int		COMMUN_Extension_Shell(char *p_extension);
