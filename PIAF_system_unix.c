...
#define PIAF_SYS_VERSION_FICHIER	"1.5"
...
int PIAF_appel_systeme(char *param, char *fic_sor, char *fic_err)
{
...
int PIAF_ecrit_fichier(char *p_param, char *p_fic_sor, char *p_mode, char *p_type_ecriture, char *p_type_trace)
{
	FILE *fichier = NULL;
...
int ASTER_env_param(char *p_separateur_chemin, char *p_separateur_var_path) 
{
	int v_retour =  PIAF_EXEC_OK;
...
int ASTER_efface_fichier(char *p_nom_fichier)
{
	int v_retour;
...
int ASTER_get_crypt_key(char *p_retour) 
{
...
int ASTER_get_crypt_masque(char *p_retour) 
{
	int v_ret =  PIAF_EXEC_OK;
...
@(#) ASTER_get_date_fichier|21/02/2003 | SGN	| Creation (@fonction)
 ====================================================================================
*/
int ASTER_get_date_fichier(char *p_fichier, char *p_type_date, char *p_date, char *p_heure) 
{
    int v_ret = 0;
...
@(#) ASTER_is_fichier_perime|21/02/2003 | SGN	| Creation (@fonction)
 ====================================================================================
*/
int ASTER_is_fichier_perime(char *p_fichier, char *p_date_trt , char *p_duree_conservation) 
{
...
@(#) ASTER_Purge_Liste_Fichiers	|24/02/2003 | SGN	| Creation (@fonction)
 ====================================================================================
*/
int ASTER_Purge_Liste_Fichiers(char *p_nom_rep, char *p_ext_fich, char *p_dat_trt, char *p_duree_conservation) 
{
	int v_ret = TRT_OK;
#ifdef WIN32
